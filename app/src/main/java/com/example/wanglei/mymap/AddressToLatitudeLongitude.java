...
public class AddressToLatitudeLongitude {
    ...
    public void getLatAndLngByAddress(){
        ...
        try {
            ...
            Log.d(addr+address, "getLatAndLngByAddress: ");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        String url = String.format("http://api.map.baidu.com/geocoder/v2/?"
                +"address=%s&ak=DjSaqp4DfftIPy9GaSUqLSt4lhMcU7Kn&mcode=5D:3C:A4:A3:B3:D7:FB:97:29:C2:B9:92:7C:0A:91:6B:FB:77:F7:48;com.example.wanglei.mymap&output=json",addr);
        URL myURL = null;
